"""
Django settings for panchangam_39889 project.
...
ROOT_URLCONF = 'panchangam_39889.urls'
...
WSGI_APPLICATION = 'panchangam_39889.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "panchangam_39889 API",
    "DESCRIPTION": "API documentation for panchangam_39889 App",
    "VERSION": "v1",
}
